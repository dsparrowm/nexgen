...
const ForgotPassword = () => {
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            ...
            const errorMessage = (axiosError.response?.data as any)?.message || 'Failed to send reset email. Please try again.';
            ...
            >
                ...
                <div className="absolute inset-0 flex items-center justify-center text-white z-30 p-8">
                    ...
                    >
                        ...
                        >
                            Reset your password securely and get back to mining with confidence.
                        </motion.p>
                    </motion.div>
                </div>
            </motion.div>
